...
def hl_shares_aua(dic_data, df=aua_frame):
    ...
    return df['vantage_hl_shares_aua'].fillna(method='ffill').multiply((hl_return+1).cumprod())
...
def other_shares_aua(dic_data, df=aua_frame):
    ...
    return df['vantage_other_shares_aua'].fillna(method='ffill').multiply((returns+1).cumprod())
...
def other_funds_aua(dic_data, df=aua_frame):
    ...
    return df['vantage_other_funds_aua'].fillna(method='ffill').multiply((composite_returns+1).cumprod())
